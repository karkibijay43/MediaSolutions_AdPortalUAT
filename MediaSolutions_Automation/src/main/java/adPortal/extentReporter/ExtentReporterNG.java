/*
 * package adPortal.extentReporter; import java.io.File; import
 ...
 * extent.flush(); }
 * 
 * private void init() { ExtentHtmlReporter htmlReporter = new
 * ExtentHtmlReporter(OUTPUT_FOLDER + FILE_NAME); htmlReporter.config().
