...
/*
 * extends TestBase { WebDriver driver; SignUpPage signUpPage = new
 * SignUpPage(driver); //xsPageFactory.initElements driver, SignUpPage ;
 * 
 * 
 * @Given("^User is on AdPortal UAT sign up page$") public void
 * user_is_on_AdPortal_UAT_sign_up_page () throws Throwable {
 ...
 * "https://adportal-uat.brandcdnstage.com/sign-up-1"; driver.get(SSO_SignUpUrl
 * ); driver.manage().window().maximize(); }
 * 
 * @When("^User enters First Namme as \"([^\"]*)\" and Last Name as \"([^\"]*)\"$"
 * ) public void user_enters_First_Namme_as_and_Last_Name_as(String arg1, String
 * arg2) throws Throwable { SignUpPage.txtBox_FirstName.isEnabled();
 * SignUpPage.enter_FirstName(arg1); SignUpPage.enter_LastName(arg2);
 * 
 * throw new PendingException(); }
 * 
 * @When("^User enters Business Name as \"([^\"]*)\"$") public void
 * user_enters_Business_Name_as(String arg1) throws Throwable {
 * SignUpPage.enter_BusinessName(arg1); throw new PendingException(); }
 * 
 * @When("^USer Enters Zip Code as \"([^\"]*)\" and Phone NUmbmer as \"([^\"]*)\"$"
 * ) public void user_Enters_Zip_Code_as_and_Phone_NUmbmer_as(String arg1,
 * String arg2) throws Throwable { SignUpPage.enter_ZipCode(arg1);
 * SignUpPage.enter_PhoneNumber(arg2); throw new PendingException(); }
 * 
 * @When("^User enters Email as \"([^\"]*)\" and confirms Email as \"([^\"]*)\"$"
 * ) public void user_enters_Email_as_and_confirms_Email_as(String arg1, String
 * arg2) throws Throwable { SignUpPage.enter_Email(arg1);
 * SignUpPage.enter_ConfirmEmail(arg2); throw new PendingException();
 * 
 * }
 * 
 * @When("^USer enter Password as \"([^\"]*)\" and confirms password as \"([^\"]*)\"$"
 * ) public void user_enter_Password_as_and_confirms_password_as(String arg1,
 * String arg2) throws Throwable { SignUpPage.enter_Password(arg1);
 * SignUpPage.eneter_ConfirmPassword(arg2); throw new PendingException(); }
 * 
 * @Then ("User Reads and agrees Terms and conditions and clicks Next Step$")
 * public void read_Accept_licenseAgreement() { SignUpPage.click_CheckBox();
 * 
 * ArrayList<String> tabs = new ArrayList<String>(driver.getWindowHandles());
 * 
 * driver.switchTo().window(tabs.get(1));
 ...
 * 
 * @Then ("User should be able to create log in credentiasls for Adportal UAT$")
 * public void next_step_LogIn() { WebElement nextStep =
 * driver.findElement(By.className("spp-btn")); if (nextStep.isEnabled()) {
 * nextStep.click(); } else {
