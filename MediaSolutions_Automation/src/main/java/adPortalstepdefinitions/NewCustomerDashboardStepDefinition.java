...
public class NewCustomerDashboardStepDefinition {
	WebDriver driver;
	...
	public void enter_DataField() {
		...
		email.sendKeys("SpectrumReachTestEmail@charter.com");

		WebElement confirmEmail = driver.findElement(By.id("confirm-email"));
		confirmEmail.sendKeys("SpectrumReachTestEmail@charter.com");
